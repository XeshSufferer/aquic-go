...
//
//	mockgen -typed -package quic -self_package github.com/XeshSufferer/aquic-go -self_package github.com/XeshSufferer/aquic-go -destination mock_packetconn_test.go net PacketConn
//
